...
import { showServicesData, addServicesData } from '../services/Api';
                    ...
                    <div className='card'>
                        ...
                        <div className='card-body'>
                            ...
                            <div className='row'>
                                ...
                                <div className='col-6 mt-3 text-center'>
                                    {
                                        <button className='btn btn-success btn-sm' onClick={addAllServicesData}>Add Services</button>
                                    }
                                    {
                                        <button className='btn btn-warning btn-sm' > Update Service</button>
                                    }
                                </div>
                            </div>
                        </div>
